CREATE DATABASE databaseairportmanagementsystem;

use databaseairportmanagementsystem;
...
-- Stored procedure​​ 1 : get_passenger_details
...
CREATE PROCEDURE get_passenger_details1
(
...
CALL  get_passenger_details1 ( 'Vivek', 'Sharma' ,'QR2306');


-- Stored procedure 2 ​​: get_flight_details
...
-- Trigger 1 :  when flight is delayed it is logged into different table--
...
NoOfStops ,
AirlineID)
VALUES('AI122','BOM','DFW','02:10','03:15','Delayed','24hr','Connecting',3,1,'AI');
...
NoOfStops ,
AirlineID)
VALUES('QR122','BOM','DFW','02:10','03:15','Delayed','24hr','Connecting',3,1,'AI');
...
-- TRIGGER 2 :  TO UPDATE 'TICKET_PRICE_HISTORY' TABLE WHEN THE PRICE OF AN AIR TICKET IS UPDATED IN TICKET2 TABLE--
...
-- TRIGGER 3  TO UPDATE SALARY OF AN EMPLOYEE DEPENDING ON JOBTYPE--
DELIMITER //
